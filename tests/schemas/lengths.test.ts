...
describe('lengths', () => {
  ...
  describe('column limits', () => {
    ...
    it('SOURCE_COMMENT_RUN_ID_MAX_LENGTH is 75, same as CODERABBIT_RUN_ID_MAX_LENGTH', () => {
      expect(SOURCE_COMMENT_RUN_ID_MAX_LENGTH).toBe(75);
      expect(SOURCE_COMMENT_RUN_ID_MAX_LENGTH).toBe(CODERABBIT_RUN_ID_MAX_LENGTH);
    });
