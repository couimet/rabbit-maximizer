            ...
            <tbody>
              {items.map((item) => (
                <tr key={item.uuid} className={item.status === 'completed' ? 'row-status-completed' : ''}>
                  ...
                  <td>
                    {item.retrigger_comment_url ? (
                      <a href={item.retrigger_comment_url} target="_blank" rel="noreferrer">
                        view
                      </a>
                    ) : (
                      '—'
                  ...
                  <td>{item.trigger_source === 'dashboard_retrigger_now' ? <span className="badge manual">manual</span> : '—'}</td>
                  <td>
                    {item.status === 'completed' ? (
                      <span className="status-dot completed" title="Completed" />
                    ) : (
                      <span className="status-dot retriggered" title="Retriggered" />
                    )}
                  </td>
                  <td>
                    {item.status !== 'completed' && (
