...
export const parseConfig = (raw: Record<string, string | undefined>): Result<Config, string[]> => {
  ...
  const prepped = {
    ...
    GITHUB_API_TIMEOUT_MS: emptyToUndefined(raw.GITHUB_API_TIMEOUT_MS),
    GITHUB_PAT: emptyToUndefined(raw.GITHUB_PAT),
    PAUSE_NOTIFICATION_INITIAL_DELAY_MINUTES: emptyToUndefined(raw.PAUSE_NOTIFICATION_INITIAL_DELAY_MINUTES),
    PAUSE_NOTIFICATION_REPEAT_INTERVAL_MINUTES: emptyToUndefined(raw.PAUSE_NOTIFICATION_REPEAT_INTERVAL_MINUTES),
    POLL_INTERVAL: emptyToUndefined(raw.POLL_INTERVAL),
    REPO_FILTER: parseRepoFilter(raw.REPO_FILTER),
    REVIEW_LIMIT_BUFFER_SECONDS: emptyToUndefined(raw.REVIEW_LIMIT_BUFFER_SECONDS),
    ...
    SCHEDULER_TICK_INTERVAL_MS: emptyToUndefined(raw.SCHEDULER_TICK_INTERVAL_MS),
...
const parsed = parseConfig({
  ...
  GITHUB_API_TIMEOUT_MS: process.env.GITHUB_API_TIMEOUT_MS,
  GITHUB_PAT: process.env.GITHUB_PAT,
  PAUSE_NOTIFICATION_INITIAL_DELAY_MINUTES: process.env.PAUSE_NOTIFICATION_INITIAL_DELAY_MINUTES,
  PAUSE_NOTIFICATION_REPEAT_INTERVAL_MINUTES: process.env.PAUSE_NOTIFICATION_REPEAT_INTERVAL_MINUTES,
  POLL_INTERVAL: process.env.POLL_INTERVAL,
  REPO_FILTER: process.env.REPO_FILTER,
  REVIEW_LIMIT_BUFFER_SECONDS: process.env.REVIEW_LIMIT_BUFFER_SECONDS,
  ...
  SCHEDULER_TICK_INTERVAL_MS: process.env.SCHEDULER_TICK_INTERVAL_MS,
