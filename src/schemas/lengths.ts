...
// Column limit for run_id on events and review_queue — our own run id (RunIdGenerator), printed as `run=` in the posted comment footer. CHECK in the 20260910 migration.
