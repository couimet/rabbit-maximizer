...
export const ConfigSchema = z
  .object({
    ...
    PAUSE_NOTIFICATION_INITIAL_DELAY_MINUTES: z.coerce.number().int().positive().default(30),
    PAUSE_NOTIFICATION_REPEAT_INTERVAL_MINUTES: z.coerce.number().int().positive().default(15),
