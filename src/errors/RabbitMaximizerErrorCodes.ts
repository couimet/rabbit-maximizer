...
export enum RabbitMaximizerErrorCodes {
  ...
  EDIT_DETECTION_FAILED = 'EDIT_DETECTION_FAILED',

  GITHUB_API_ERROR = 'GITHUB_API_ERROR',
  GITHUB_AUTH_ERROR = 'GITHUB_AUTH_ERROR',
  GITHUB_INVALID_COMMENT_URL = 'GITHUB_INVALID_COMMENT_URL',
  GITHUB_NOT_FOUND = 'GITHUB_NOT_FOUND',
  GITHUB_RATE_LIMITED = 'GITHUB_RATE_LIMITED',
  MISSING_VERSION_ATTRIBUTE = 'MISSING_VERSION_ATTRIBUTE',
  ...
  RETRIGGER_ITEM_NOT_PENDING = 'RETRIGGER_ITEM_NOT_PENDING',
