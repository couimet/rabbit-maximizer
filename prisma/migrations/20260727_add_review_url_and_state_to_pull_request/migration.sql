...
ALTER TABLE "pull_request" ADD COLUMN "last_review_state" TEXT CHECK("last_review_state" IS NULL OR (length("last_review_state") <= 25 AND "last_review_state" IN ('review_approved', 'review_changes_suggested')));
